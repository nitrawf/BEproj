...
if __name__ == "__main__":
    ...
    Y_testset=Y[:,400:]
    n_h=7
    costs,parameters = nn_model(X_trainset, Y_trainset, n_h , num_iterations = 3000, print_cost=True)
    ...
    plt.show()
    with open("liver_parameters.txt", "wb") as wf:
        pickle.dump({"parameters" : parameters, "mean" : Xmeans, "std" : Xdevs}, wf)
